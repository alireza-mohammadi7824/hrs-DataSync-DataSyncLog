...
public static class HRSDataIntegrationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE HRSDataIntegrationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
